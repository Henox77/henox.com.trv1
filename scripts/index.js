...
const discordId = "852854815071666177";
...
const reloadUser = async (data) => {
  ...
  $('div-img.avatar').css('background-image', `url(https://cdn.discordapp.com/avatars/${discordId}/${data.discord_user.avatar}.png?size=512)`).removeAttr('loading');
  ...
  <a class="discord" href="https://discord.gg/lavictoria" target="_blank">Discord</a>`);
...
function showGithubRepos() {
  const getGitHubData = async () => {
    const response = await fetch(properties.github_api.baseURL + '/users/Henox77/');
  ...
  const socials = [
    {
      ...
      href: 'https://instagram.com/olduremezler',
      tippy: 'Instagram'
    },
    {
    ...
    },
    {
      ...
      href: `https://discord.gg/lavictoria`,
      tippy: 'Discord'
    },
    {
